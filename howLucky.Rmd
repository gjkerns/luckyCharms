...
```
**WOW.**  25.3 charms on average.  That corresponds to just over a 52% reduction in charms from the first bowl to the 11th.  No, it was most definitely not my imagination. Forget the multiple linear regression models and 3D visualizations, a hungry toddler ought to easily detect this difference by taste alone.

The next question is: Why?  A textbook argument on physical grounds might go something like this: consider a box of Lucky Charms to be a simple mechanical mixture of frosted toasted oats and marshmallows. Many external forces agitate the box over the course of its lifetime, such as jostling during transport, placement on the store shelf, transit to the home, not to mention activity in and around the cupboard.  This leads to an inevitable  shifting of contents, with the slightly less dense marshmallows migrating toward the top of the box, while the more dense toasty oats settle toward the bottom.  This rationale is logical, anyway.  But it leaves several other related questions unanswered:
