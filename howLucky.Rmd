...
**The `tl;dr` version:** in a given box of Lucky Charms, for each bowl of cereal eaten we estimate a decrease of approximately 2.7 total charms per bowl on average.  The weight of cereal also appears to play a role when suitably included and for each increase of 1g of cereal we estimate approximately 0.5 more charms on average---with bowl held constant. This corresponds to a reduction of over 50% in charms from the 1st bowl to the last. The interaction between bowl and weight is not statistically significant.
...
I originally thought that either the whole thing would turn out to be a figment of my imagination or the effect would be too small to detect without LOTS AND LOTS of boxes of Lucky Charms.  Both alternatives turned out to be false.  The effect is real, and is big enough to detect with a mere handful of boxes.

## The Lucky Charms drop-off
...
```
That is, almost 53 charms in the first bowl.  What about the last bowl?  Okay, not every box made it to `Bowl 13`, but they all made it to `Bowl = 11`.  How many charms?

```{r}
33.3168 + (-2.7552)*11 + 0.4819*46.3
```
WOW.  25.3 charms on average.  This corresponds to just over a 52% reduction in charms from the first bowl to the eleventh.  No, it wasn't my imagination, any person should be able to detect this easily by taste alone.

Then the next question is: why?  The standard explanation on physical grounds for the effect would probably go along the lines of considering a box of Lucky Charms as a simple mixture of cereal and marshmallows, with the notion that over time, due to many external factors affecting the box such as jostling during transport, placement on the store shelf, transit to the home, and activity in and out of the cupboard, that there is a certain degree of movement throughout the box's contents, with the less dense marshmallows migrating toward the top, and the slightly more dense frosted toasty oats settling toward the bottom.  This is logical, anyway.  But there are several open questions that merit further investigation:
