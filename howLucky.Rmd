...
The next question is: Why?  A standard argument on physical grounds might go something like this: imagine a box of Lucky Charms as a simple mechanical mixture of toasted oats and marshmallows. Over time, many external factors perturb the box such as jostling during transport, placement on the store shelf, transit to the home, and activity in and around the cupboard, and so there is a shifting of contents, with the slightly less dense marshmallows migrating toward the top of the box, and the more dense frosted toasty oats settling toward the bottom.  This rationale is logical, anyway.  But it leaves other related questions unanswered:

- Does the same pattern hold true for the individual charms? (A quick glance suggests "No".)
- Is the association truly linear, or would some amount of curvature better describe the relationship?
