...
**The `tl;dr` version:** A team of students did an experiment to determine whether bowls of Lucky Charms get less "lucky" over the course of a box of cereal.  We estimate a decrease of approximately 2.7 total charms per additional bowl on average.  The weight of cereal also appears to play a role, and for each 1g of cereal we estimate approximately 0.5 more charms on average---with bowl held constant. This corresponds to more than a 50% dropoff in charms from the first bowl to the last. The interaction between bowl and weight is not statistically significant.
...
I happened to be teaching a summer upper-division undergraduate probability & statistics course at the time and the four students and I were determined to find out.
...
Equipped with these data we can report things like the mean observed `Weight` was approximately 46.3g, the maximum number of a particular charm in any one bowl was 15 (Pink Hearts tied with Purple Horseshoes), and so forth.  We could spend all day computing endless statistics on this dataset to our Pink Heart's content, but at the moment we are primarily concerned with `Totcharms` and how the variable relates to `Bowl` and maybe `Weight` to a lesser degree.
...
Now we see that the extra-heavy bowl was the last `Bowl = 12` of `Box = 1`.  The details behind that particular data point have unfortunately been lost to the sands of time, but bearing in mind that this was the first box the team had ever finished, near the end it may have been difficult to judge how much cereal was left, and perhaps all the remainder was poured into that final twelfth bowl---I personally do the same thing routinely at breakfast as I near the end of a box of cereal.  Looking at the points on the graph, if that 12th bowl of almost 70g had been split into (say) two bowls of 40g and 30g, respectively, then there would have been two boxes that made it to 13 bowls instead of one box, and maybe the models below would have fit the observed data slightly better.  Alas!  We will never know. Such is the scientific enterprise.
...
I originally thought that either the whole thing would turn out to be a figment of my imagination or the effect would be too small to detect without LOTS AND LOTS of boxes of Lucky Charms.  Both alternatives turned out to be false.  The effect is real, and is big enough to detect with a handful of boxes.  Literally two hands full.  

## The Lucky Charms dropoff

The final model permits us to quickly arrive at some startling conclusions.  For example: how many charms do we estimate to be in an opening bowl of a box of Lucky Charms?  We saw earlier that the average `Weight` in this study was 46.3g.  When `Box = 1` the model estimates the average `Totcharms` to be
...
```
WOW.  25.3 charms on average.  This corresponds to just over a 52% reduction in charms from the first bowl to the eleventh.  No, it was most certainly not my imagination. Any hungry toddler could easily detect this effect by taste alone.

Then the next question is: Why?  A standard explanation on physical grounds might go something like this: imagine a box of Lucky Charms as a simple mechanical mixture of toasted oats and marshmallows. Over time, due to many external factors perturbing the box such as jostling during transport, placement on the store shelf, transit to the home, and activity in and around the cupboard, there is a certain shifting of contents, with the slightly less dense marshmallows migrating toward the top of the box and the more dense frosted toasty oats settling toward the bottom.  This rationale is logical, anyway.  This leads to further questions:
...
Moving forward, more data is needed to better estimate the Lucky Charm dropoff, and strategies should be tested in search of procedures to distribute the charms uniformly throughout the entirety of the cereal box.  If successful, the first bowl of the box might not be so magical, but on the other hand, maybe those final bowls won't feel like such a chore waiting for the next brand new box of Lucky Charms!
